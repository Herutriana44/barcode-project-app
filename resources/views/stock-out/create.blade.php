<x-app-layout>
    <x-slot name="header">
        <h2 class="font-bold text-3xl text-egg-900 leading-tight">Pengeluaran FIFO</h2>
    </x-slot>
    ...
    <div class="py-8 w-full">
        <div class="max-w-2xl mx-auto w-full">
            ...
            @endif
            <div class="bg-white border border-egg-200 rounded-xl p-6 md:p-8 text-base shadow-md">
                <p class="text-base text-egg-700 mb-6 leading-relaxed">Stok dikurangi dari batch <strong>paling lama</strong> (tanggal terima FG / entri lama) sesuai jenis stok.</p>
                ...
                <form method="POST" action="{{ route('stock-out.store') }}" class="space-y-3">
                    ...
                    <div>
                        <label class="block text-base font-medium text-egg-800">Jenis stok *</label>
                    ...
                    <div>
                        <label class="block text-base font-medium text-egg-800">Qty keluar *</label>
                    ...
                    <div>
                        <label class="block text-base font-medium text-egg-800">Filter part number (opsional, barcode barang)</label>
                        <input type="text" name="part_number" value="{{ old('part_number') }}"
                            class="mt-0.5 block w-full rounded border-egg-300 text-sm py-1 shadow-sm" />
                    </div>
                    <div>
                        <label class="block text-base font-medium text-egg-800">Filter part name (opsional)</label>
