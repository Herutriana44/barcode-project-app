...
<div>
    <label class="block text-base font-medium text-egg-800">Status</label>
    <input type="text" name="status" value="{{ old('status', $e->status ?? '') }}" maxlength="255"
        class="mt-1 block w-full rounded-lg border-egg-300 text-base py-2.5 shadow-sm focus:border-egg-500 focus:ring-egg-500" />
    @error('status')<p class="text-red-600 text-xs mt-0.5">{{ $message }}</p>@enderror
</div>
<div>
