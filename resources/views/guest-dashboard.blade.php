...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased text-egg-900 min-h-screen flex flex-col bg-egg-50">
        ...
        <main class="flex-1">
            <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-16 md:pt-20 md:pb-24 text-center">
                <p class="text-sm font-medium text-egg-600 uppercase tracking-wide mb-3">Barcode &amp; gudang</p>
                <h1 class="text-3xl sm:text-4xl md:text-5xl font-bold text-egg-900 leading-tight">
                    Kelola barcode barang &amp; perusahaan dalam satu tempat
                </h1>
                <p class="mt-6 text-lg text-egg-700 max-w-2xl mx-auto leading-relaxed">
                    Generate label, kelompokkan per perusahaan, dan scan untuk melihat detail—setelah masuk ke akun Anda.
                </p>
            ...
            <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
                <h2 class="text-center text-xl font-semibold text-egg-900 mb-10">Yang bisa Anda lakukan setelah login</h2>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <article class="bg-white border border-egg-200 rounded-xl p-6 shadow-sm text-left hover:border-egg-300 transition-colors">
                        <div class="inline-flex p-3 rounded-lg bg-egg-100 text-egg-800 mb-4">
