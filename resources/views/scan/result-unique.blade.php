        ...
        <div class="max-w-4xl mx-auto w-full space-y-6">
            ...
            @elseif ($approachingExpiry ?? false)
                <div class="p-4 rounded-lg border border-orange-300 bg-orange-50 text-orange-900 text-base leading-snug" role="alert">
                    ...
                    <p class="mt-1">Barang ini akan expired pada tanggal {{ $uniqueItem->expired_date?->format('d/m/Y') ?? $item->tgl_expired?->format('d/m/Y') }}. Disarankan untuk segera dikeluarkan (FIFO).</p>
                </div>
            @endif
